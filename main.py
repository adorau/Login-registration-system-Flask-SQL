...
def register():
    if request.method == "POST":
        ...
        object = User(
            ...
            password=werkzeug.security.generate_password_hash(password=request.form.get("password"),
...
@login_required
def secrets():
    return render_template("secrets.html", name=current_user.name, logged=True)
